...
const Dashboard: React.FC = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      content: <img src={brain} alt="brain" className="w-2/3 h-auto rounded-lg mt-4 mx-auto animate-flip" />
    },
    {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="text-center mb-12">
        <h1 className="text-7xl md:text-8xl font-bold tracking-widest">{isBrainrot ? 'BRAINROTTER' : 'Dashboard'}</h1>
